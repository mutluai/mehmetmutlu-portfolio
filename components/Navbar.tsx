...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6 reveal">
      <div className="max-w-7xl mx-auto flex justify-between items-center bg-white/40 backdrop-blur-xl border border-black/5 rounded-3xl px-8 py-3">
        ...
        <div className="hidden md:flex gap-10 items-center">
          ...
          <a href="#contact" className="px-6 py-2 bg-black text-white text-sm rounded-full font-bold hover:scale-105 transition-all">
            Connect
          </a>
        </div>
      </div>
